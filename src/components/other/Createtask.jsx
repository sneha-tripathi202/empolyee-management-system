...
const Createtask = () => {
 ...
 const [task, setTask] = useState({})
    ...
    data.forEach((ele)=>{
     if(asignTo==ele.name) {console.log(ele);}
        ...
        <div className='p-5 bg-[#1c1c1c] mt-7 rounded '>
                <form onSubmit={(e)=>{submitHandler(e)}} className='flex flex-wrap  w-full  items-start justify-between'>
                    ...
                    <div><h3 className='text-sm text-gray-300 mb-0.5'>Asign to</h3>
                        ...
                        }} className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border' type="text" placeholder='employee name' /></div>
